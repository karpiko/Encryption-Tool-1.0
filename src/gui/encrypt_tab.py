...
class EncryptTab(ctk.CTkFrame):
    ...
    def _create_file_input_section(self):
        ...
        self.input_entry = ctk.CTkEntry(
            ...
            placeholder_text="Select file to encrypt...",
            **ENTRY_CONFIG,
        )
    ...
    def _create_algorithm_section(self):
        ...
        info_label = ctk.CTkLabel(
            algo_frame,
            text="Fernet: Recommended for most use cases | AES-256: For large files",
            text_color=DAVENPORT_DARK_GRAY,
            font=("Segoe UI", 9),
            anchor="w",
        )
    ...
    def _create_key_section(self):
        ...
        self.key_entry = ctk.CTkEntry(
            ...
            placeholder_text="Select encryption key file...",
            **ENTRY_CONFIG,
        )
    ...
    def _create_output_section(self):
        ...
        self.output_entry = ctk.CTkEntry(
            ...
            placeholder_text="Enter output file name (e.g., file.enc)...",
            **ENTRY_CONFIG,
        )
    ...
    def _create_buttons(self):
        ...
        self.encrypt_btn.pack(side="left", padx=(0, 10), fill="x", expand=True)
    ...
    def _encrypt_file(self):
        ...
        if not self.input_var.get():
            MessageHelper.show_error("Input Error", "Please select an input file")
            return
        ...
        self.app.update_status("Encrypting file...", "info")
        ...
        def do_encrypt():
            try:
                ...
                self.app.update_status(
                    f"✓ File encrypted successfully: {output_file}", "success"
                )
                ...
                self.app.update_status(f"Encryption failed: {str(e)}", "error")
                MessageHelper.show_error("Encryption Error", str(e))
            finally:
                self.encrypt_btn.configure(state="normal")

        ThreadHelper.run_in_thread(do_encrypt)
